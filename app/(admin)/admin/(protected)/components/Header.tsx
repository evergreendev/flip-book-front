...
const Header = () => {
    return <div className="w-full bg-slate-800 text-white p-4 flex items-center justify-center gap-2">
        <Link className="border-white border px-1" href="/admin/dashboard/register">Add User</Link>
        <Link className="border-white border px-1" href="/admin/dashboard/flipbooks">View Flipbooks</Link>
